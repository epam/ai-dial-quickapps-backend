...
| `DEFAULT_FILE_LOADER_SIZE_LIMIT`           | `10485760`                 | No       | Deployment-wide default maximum size (in bytes) for files the agent downloads. Apps can override per-app via `features.file_loader.size_limit`. |
| **Feature Gating**                         |                            |          |                                                                                                              |
