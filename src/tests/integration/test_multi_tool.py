...
@e2e_test(config_file_set="integration",
        ...
        answer=[
            "Here is the image of Kyiv with the current weather. Did you like it? [1]"
        ],
    ),
          )
...
@e2e_test(config_file_set="integration",
        ...
        user_message="""Based on attached PDF file: extract the GDP forecast data for the next countries: India, China, Brazil, Japan, United States with rag search tool, then calculate the average GDP Growth with py interpreter tool.
