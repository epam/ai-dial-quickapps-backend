...
class AttachmentConfig(BaseModel):
    ...
    handling_mode: AttachmentHandlingMode = Field(
        default=AttachmentHandlingMode.upload_to_core,
        description=(
            "How to handle attachments generated by QuickApps tools: upload_to_core uploads content "
            "to DIAL Core and returns Core URLs; inline keeps original content in attachment fields "
            "and skips upload."
        ),
    )
