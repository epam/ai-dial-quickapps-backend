...
| [Application Schema](./generated-app-schema.json) | Generated JSON schema for application configs, validated by DIAL Core. Auto-generated by `make format`; staleness checked by `make lint`. |
...
| [Chat HUB](chathub.md)                                  | Reference configurations and development guide for the Chat HUB application, a sample Quick App demonstrating agent capabilities.          |"
