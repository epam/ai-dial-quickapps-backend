...
**Owner:** Request-scoped `ExternalUrlFetchPolicyResolver` in `src/quickapp/common/external_url_fetch_policy_resolver.py`, mirroring `FileLoadingSizeLimitResolver`. The resolver exposes two methods:
